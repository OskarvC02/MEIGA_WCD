// implementation of the G4RCPhysicsList class
...
G4RCPhysicsList::G4RCPhysicsList(G4String physName) : G4VModularPhysicsList()
{
...
G4RCPhysicsList::~G4RCPhysicsList()
{
		//delete fMessenger;
...
void 
G4RCPhysicsList::ConstructParticle()
{
...
void 
G4RCPhysicsList::ConstructProcess()
{
...
void 
G4RCPhysicsList::RemoveFromPhysicsList(const G4String& name)
{
...
void 
G4RCPhysicsList::SetAbsorption(G4bool toggle)
{
...
void 
G4RCPhysicsList::SetCutForGamma(G4double cut)
{
	fCutForGamma = cut;
...
void 
G4RCPhysicsList::SetCutForElectron(G4double cut)
{
	fCutForElectron = cut;
...
void 
G4RCPhysicsList::SetCutForPositron(G4double cut)
{
	fCutForPositron = cut;
...
void 
G4RCPhysicsList::SetStepMax(G4double step)
{
	fStepMaxProcess->SetStepMax(step);
}

StepMax* 
G4RCPhysicsList::GetStepMaxProcess()
{
	return fStepMaxProcess;
}

void 
G4RCPhysicsList::AddStepMax()
{
...
void 
G4RCPhysicsList::SetNbOfPhotonsCerenkov(G4int maxNumber)
{
...
void 
G4RCPhysicsList::SetVerbose(G4int verbose)
{
