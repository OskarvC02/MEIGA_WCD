// definition of the G4RCDetectorConstruction class
#ifndef G4RCDetectorConstruction_h
#define G4RCDetectorConstruction_h 1
...
class G4RCDetectorConstruction : public G4VUserDetectorConstruction {
	...
	public:
		G4RCDetectorConstruction(Event& theEvent);
		virtual ~G4RCDetectorConstruction();
