#ifndef G4RCSimulator_h
#define G4RCSimulator_h 1
...
class G4RCSimulator 
{
  public:
    ...
    static G4RCSimulator* fG4RCSimulator;
  ...
  private:
    ...
    std::string fPhysicsName = "QGSP_BERT_HP";
  	...
  	friend class G4RCDetectorConstructor;
  	friend class G4RCPrimaryGenerator;
};
