...
G4RCEventAction::G4RCEventAction(Event& theEvent) : 
	fEvent(theEvent),
	G4UserEventAction()
{
...
void
G4RCEventAction::BeginOfEventAction(const G4Event*)
{

}

void 
G4RCEventAction::EndOfEventAction(const G4Event*)
{

	// set total deposited energy at RC detector
