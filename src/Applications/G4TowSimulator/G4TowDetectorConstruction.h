// definition of the G4TowDetectorConstruction class
#ifndef G4TowDetectorConstruction_h
#define G4TowDetectorConstruction_h 1
...
class G4TowDetectorConstruction : public G4VUserDetectorConstruction {
	
	public:
		G4TowDetectorConstruction(Event& theEvent);
		virtual ~G4TowDetectorConstruction();
